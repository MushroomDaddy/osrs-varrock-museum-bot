# Varrock Museum Cleaner Bot (PowerBot)

An advanced OSRS bot script for PowerBot that automates cleaning specimen finds at the Varrock Museum.

## 🎯 Features

- **Fully Automated**: Mines specimens → Cleans finds → Stores artifacts → Repeats
...
- **PowerBot** - [Download here](https://www.powerbot.org/)
- **Gear Needed**:
  - Leather gloves
  - Leather boots
...
- **Option 1**: Tap the 🗑️ DROP icon in the right sidebar (mobile/tablet view)
- **Option 2**: Settings → Controls → "Tap to Drop" toggle ON
...
2. Place it in your PowerBot scripts folder:
   - Windows: `C:\Users\[YourName]\.powerbot\scripts\src`
   - macOS: `~/.powerbot/scripts/src`
3. Restart PowerBot or click "Refresh Scripts"
...
2. Mine specimen rocks → Fill inventory
...
- Automatically clicks lamp → Selects Slayer skill → Confirms
...
### v32 - Current Version
- ✅ Tap-to-drop only (removed Drop action)
- ✅ Fixed camera adjustment (pitches UP properly)
- ✅ Removed inventory opening before object clicks
- ✅ Slower, more human-like drop timing (150-250ms)
- ✅ Randomized drop order every time
- ✅ Widget-based lamp detection (all 6 lamp types)
- ✅ Smart storage crate clicking (no spam)
...
Developed for PowerBot OSRS automation framework.

---

**Enjoy botting responsibly!** 🤖
